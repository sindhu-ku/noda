...
def main(argv):
  chi2maps, grid = np.load(f"chi2maps_newbkg_Jun27_free_{pmt_opt}_{stat_opt}_411.npy", allow_pickle=True)
  file_out = open(f"fit_results_newbkg_Jun27_{stat_opt}.txt", "a")
  file_out.write("unc sin2_12 sin2_12_err sin2_13 sin2_13_err dm2_21 dm2_21_err dm2_31 dm2_31_err\n")

#  plt.plot(grid['dm2_31'], chi2maps['stat'][5,6,:])
#  plt.show()
#  sys.exit()
  ...
  for unc in chi2maps.keys():
    ...
    print(unc, end='\t')
    if not os.path.exists("Plots_th13free_dm2_31_fit"): os.mkdir("Plots_th13free_dm2_31_fit")
    if not os.path.exists("Plots_th13free_dm2_31_fit/Chi2_profiles"): os.mkdir("Plots_th13free_dm2_31_fit/Chi2_profiles")
    for op in op_list:
  ...
  #    print(chi2marg[op])
      ...
      plt.savefig("Plots_th13free_dm2_31_fit/Chi2_profiles/chi2_{}_{}_{}_{}_grid5s.pdf".format(pmt_opt, stat_opt, op, unc))
...
#  import pickle
 # with open(f"sens_{pmt_opt}_{stat_opt}_grid5s.dat", "wb") as f:
  #  pickle.dump(sens, f)
