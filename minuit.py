...
#
    ...
    print(m)
   # print(m1)
    dchi2 = abs(chi2(sin2_12=m.values[0], sin2_13=m.values[1], dm2_21=m.values[2], dm2_31=m.values[3]) - chi22(sin2_12=m1.values[0], sin2_13=m1.values[1], dm2_21=m1.values[2], dm2_31=m1.values[3]))
    print(f"delta chi2 between NO and IO assuming {args.NMO_opt}: {dchi2} and corresponding significance: {np.sqrt(dchi2)}")
